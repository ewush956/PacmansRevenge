...
const UINT32* sprites[] = {
	...
	wall1_all, wall1_horz, wall1_vert,
...
*/
	...
	/*
	plot_bitmap_32(base32, 100, 200, wall1_URD, SPRITE_HEIGHT);
	plot_bitmap_32(base32, 150, 200, wall1_LD, SPRITE_HEIGHT);
	plot_bitmap_32(base32, 200, 200, wall1_LUR, SPRITE_HEIGHT);
	plot_bitmap_32(base32, 250, 200, wall1_all, SPRITE_HEIGHT);
	*/
...
/*
	...
	plot_bitmap_32(base32, offset_x + 64, 0 + offset_y, wall1_horz, SPRITE_HEIGHT);
	plot_bitmap_32(base32, offset_x + 96, 0 + offset_y, wall1_horz, SPRITE_HEIGHT);
	plot_bitmap_32(base32, offset_x + 128, 0 + offset_y, wall1_horz, SPRITE_HEIGHT);
	plot_bitmap_32(base32, offset_x + 160, 0 + offset_y, wall1_horz, SPRITE_HEIGHT);
	plot_bitmap_32(base32, offset_x + 192, 0 + offset_y, wall1_horz, SPRITE_HEIGHT);
	plot_bitmap_32(base32, offset_x + 224, 0 + offset_y, wall1_horz, SPRITE_HEIGHT);
	plot_bitmap_32(base32, offset_x + 256, 0 + offset_y, wall1_horz, SPRITE_HEIGHT);
	plot_bitmap_32(base32, offset_x + 288, 0 + offset_y, wall1_horz, SPRITE_HEIGHT);
	plot_bitmap_32(base32, offset_x + 320, 0 + offset_y, wall1_horz, SPRITE_HEIGHT);
	plot_bitmap_32(base32, offset_x + 352, 0 + offset_y, wall1_horz, SPRITE_HEIGHT);
	plot_bitmap_32(base32, offset_x + 384, 0 + offset_y, wall1_horz, SPRITE_HEIGHT);
	plot_bitmap_32(base32, offset_x + 416, 0 + offset_y, wall1_horz, SPRITE_HEIGHT);
	plot_bitmap_32(base32, offset_x + 448, 0 + offset_y, wall1_horz, SPRITE_HEIGHT);
	plot_bitmap_32(base32, offset_x + 480, 0 + offset_y, wall1_horz, SPRITE_HEIGHT);
	plot_bitmap_32(base32, offset_x + 512, 0 + offset_y, wall1_horz, SPRITE_HEIGHT);
