...
extern const ULONG32 wall_left_down_right[];
extern const ULONG32 wall_up_down[];
extern const ULONG32 wall_left_right[];
extern const ULONG32 wall_down_right[];

extern const ULONG32 tombstone[];
extern const ULONG32 ghost_run[];
extern const ULONG32 ghost_freeze[];

extern const ULONG32 wall1_all[];
extern const ULONG32 wall2_all[];

extern const ULONG32 wall1_vert[];
extern const ULONG32 wall2_vert[];

extern const ULONG32 wall1_horz[];
extern const ULONG32 wall2_horz[];

extern const ULONG32 wall1_URD[];
extern const ULONG32 wall1_LD[];
extern const ULONG32 wall1_LUR[];
extern const ULONG32 wall2_RDL[];
extern const ULONG32 wall2_RD[];
extern const ULONG32 wall2_DLU[];
extern const ULONG32 wall2_LU[];
extern const ULONG32 wall2_UR[];
extern const ULONG32 wall2_UR[];
